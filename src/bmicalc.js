  ...
  return (
    <>
      <section className="Bmical" id="Bmical">
        <div>
          <h2 className="bmi-h2">BMI Calculator</h2> <hr></hr>
          <Container className="border">
            <Row>
              <Col>
                <h3 className="bmi-para">📝 What is BMI?</h3>
                <p className="bmi-para">
                  Body Mass Index (BMI) is a simple calculation using a person’s
                  height and weight to estimate body fat and assess health risk.
                  It is widely used to categorize underweight, normal weight,
                  overweight, and obesity in adults.
                </p>
                <hr></hr>
                <h3 className="bmi-para">⚙️ How BMI is Calculated:</h3>
                <br></br>
                <p className="bmi-para">
                  BMI= Weight(kg)/[Height(m)]<sup>2</sup>
                </p>
                <p className="bmi-para">
                  Example: If you are 170 cm tall and weigh 65 kg:
                </p>
                <p className="bmi-para">
                  BMI=65/(1.70)<sup>2</sup>=22.5
                </p>
                <hr></hr>
              ...
              <Col className="mx-auto">
                <div className="styleBmi inputBmi p-4 shadow rounded bg-white">
                  ...
                  <button onClick={handleCalculate} className="styleBmi button">
                    Calculate BMI
                  </button>
                  <br></br>
                  <br></br>
                  <button
                    onClick={handleReset}
                    className="styleBmi button reset-btn"
                  >
                    Reset
                  </button>
                  {bmi && (
                    <p>
                      Your BMI is <strong>{bmi}</strong> ({status})
                    </p>
                  )}
