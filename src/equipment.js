  ...
  return (
    <>
      <section className="equip" id="equip">
        <h1 className="pro-1-h1">OUR Equipment</h1>
        <hr></hr>
          ...
          <Container>
            <Row>
              ...
              <Col className="new-color" data-aos="fade-left">
                ...
                <p className="Para-1 ">
                  🏋️‍♂️ What is a Deadlift? The deadlift is a compound
                  weightlifting exercise where you lift a loaded barbell or
                  weight from the ground up to your hips while maintaining a
                  straight back. It primarily targets your posterior chain—which
                  includes the glutes, hamstrings, and lower back.{" "}
                </p>
                <Button
            ...
            <br></br>
            <Row>
              <Col className="new-color" data-aos="fade-right">
                <h2>Gym-Ball</h2> <hr></hr>
                <p className="Para-1">
                  🏋️‍♂️ What is a Deadlift? The deadlift is a compound
                  weightlifting exercise where you lift a loaded barbell or
                  weight from the ground up to your hips while maintaining a
