...
return(
    ...
    <Container>
      <Row className="backcolor">
        <Col data-aos="fade-right"><img src={group} alt="program" width={500}/></Col>
        <Col data-aos="fade-left"><h3>Group Program</h3><hr></hr>
        <p className="para-alignment-fitness">GETFIT Gym India provides a variety of group fitness programs such as dance fitness, yoga, HIIT, and much more tailored to cater to diverse fitness preferences and goals. These group programs offer a supportive environment and a sense of community while engaging participants in fun and effective workouts.</p>
        </Col>
      </Row>
    </Container><br></br>
    </div>
    <div className="overall-2"><h1 className="middle-alginment newcolor">GETFIT Gym <span className="marked">Fitness Institute</span></h1>
    <h2 className="middle-alginment newcolor">Become a Certified Fitness Professional Today</h2>
    <h3 className="middle-alginment newcolor">Physical Activity Or Can Improve Your Health</h3>
    <Container className="mt-4">
  <Row >
    <Col md={3}>
      <div className="box img-fluid w-100 h-100"><img src={online} alt="online" style={{ maxWidth: 250 }}/><h3 className="middle-alginment newcolor">GGFI online</h3></div>
    </Col>
    <Col md={3}>
      <div className="box"><img src={offline} alt="offline" style={{ maxWidth: 250 }}/><h3 className="middle-alginment newcolor">GGFI offline</h3></div>
    </Col>
    <Col md={3}>
      <div className="box"><img src={ace} alt="ace" style={{ maxWidth: 250 }}/><h3 className="middle-alginment newcolor">ACE</h3></div>
    </Col>
    <Col md={3}>
      <div className="box"><img src={short} alt="short" style={{ maxWidth: 250 }}/><h3 className="middle-alginment newcolor">Short Courses</h3></div>
    </Col>
  </Row>
</Container>
    </div></section>
